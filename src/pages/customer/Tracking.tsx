...
import DeliveryActivityFeed from "@/components/delivery/DeliveryActivityFeed";
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <div className="space-y-4 lg:col-span-2">
          <div className="card-elevated p-5"><h2 className="mb-4 font-display text-lg font-semibold">Live activity</h2><DeliveryActivityFeed deliveryId={delivery.id} /></div>
