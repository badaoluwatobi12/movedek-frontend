...
const trust = [
  {
    ...
    desc: "ID, selfie & vehicle checks before going live.",
  },
  {
    icon: MapPin,
    title: "Live tracking",
  ...
  },
  {
    ...
    desc: "Pickup & drop-off PINs prevent mix-ups.",
  },
  {
    icon: Star,
    title: "Delivery protection",
    desc: "Optional cover on declared item value.",
  },
];
...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-background pt-[76px]">
      ...
      <header className="fixed inset-x-0 top-0 z-[100] border-b border-emerald-950/10 bg-white/90 shadow-[0_8px_30px_-24px_rgba(6,78,59,.55)] backdrop-blur-xl supports-[backdrop-filter]:bg-white/82">
        <div className="container-x flex h-[76px] items-center justify-between">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <button
              className="hidden items-center gap-2 border-r border-slate-200 pr-4 text-sm font-medium text-slate-600 xl:flex"
              type="button"
            >
            ...
            <Link to="/auth/login">
              <Button
                variant="ghost"
                className="font-semibold text-emerald-800 hover:bg-emerald-50 hover:text-emerald-900"
              >
                Sign in
              </Button>
            </Link>
      ...
      {/* HERO */}
      <section
        className="landing-hero relative text-white"
        ...
        <div className="container-x relative grid min-h-[calc(100svh-76px)] items-center gap-12 py-16 lg:grid-cols-[.95fr_1.05fr] lg:py-20 xl:min-h-[760px]">
          <div className="relative z-10 animate-fade-up">
            <span className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/10 px-4 py-2 text-xs font-semibold text-emerald-50 shadow-lg backdrop-blur">
              <Navigation className="h-3.5 w-3.5" /> Delivery built for everyday
              movement
            </span>
            <h1
              id="landing-heading"
              className="mt-7 max-w-3xl font-display text-4xl font-extrabold leading-[1.02] tracking-[-0.05em] sm:text-5xl lg:text-6xl xl:text-7xl"
            >
              Fast, trackable delivery for{" "}
              <span className="text-emerald-300">parcels, groceries</span> and
              growing businesses.
            </h1>
            <p className="mt-7 max-w-2xl text-base leading-7 text-emerald-50/85 sm:text-lg">
              Book a verified courier for parcels, groceries, pharmacy pickups,
              personal errands and business logistics. Follow every trip live
              and confirm each handoff with secure PINs.
            </p>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <Link to="/auth/register?role=customer">
                <Button
                  size="lg"
                  className="h-14 w-full rounded-2xl border border-emerald-300/70 bg-emerald-500 px-7 font-bold text-white shadow-[0_20px_45px_-18px_rgba(16,185,129,.9)] hover:bg-emerald-400 sm:w-auto"
                >
                  <Zap className="mr-2 h-4 w-4 fill-current" /> Request delivery{" "}
              ...
              <Link to="/auth/register?role=courier">
                <Button
                  size="lg"
                  variant="outline"
                  className="h-14 w-full rounded-2xl border-white/45 bg-white/5 px-7 font-bold text-white backdrop-blur hover:bg-white/15 hover:text-white sm:w-auto"
                >
            ...
            <div className="mt-8 flex flex-wrap gap-x-6 gap-y-3 text-sm text-emerald-50/80">
              <span className="flex items-center gap-2">
                <ShieldCheck className="h-5 w-5 text-emerald-300" /> ID-verified
                couriers
              </span>
              <span className="flex items-center gap-2">
                <MapPin className="h-5 w-5 text-emerald-300" /> Live tracking
              </span>
              <span className="flex items-center gap-2">
                <Lock className="h-5 w-5 text-emerald-300" /> PIN protection
              </span>
              <span className="flex items-center gap-2">
                <Star className="h-5 w-5 text-emerald-300" /> Rated service
              </span>
            </div>
          </div>
          ...
          <div
            ...
            aria-label="MoveDek live delivery tracking preview"
          >
            <div className="landing-pin landing-pin-one">
              <MapPin className="h-7 w-7" />
            </div>
            <div className="landing-pin landing-pin-two">
              <MapPin className="h-5 w-5" />
            </div>

            <div className="landing-scooter" aria-hidden="true">
              <Bike
                className="h-28 w-28 text-emerald-100/90"
                strokeWidth={1.35}
              />
            </div>
            ...
            <div className="landing-phone">
              ...
              <div className="landing-phone-screen">
                ...
                <div className="landing-map">
                  <span className="landing-map-label landing-map-label-one">
                    PICKUP
                  </span>
                  <span className="landing-map-label landing-map-label-two">
                    IN TRANSIT
                  </span>
                  <span className="landing-map-label landing-map-label-three">
                    DROP-OFF
                  </span>
                  <svg
                    viewBox="0 0 320 220"
                  ...
                  >
                    <path
                      d="M70 170 C115 170 95 125 145 122 S176 70 232 58"
                      fill="none"
                      stroke="#059669"
                      strokeWidth="7"
                      strokeLinecap="round"
                ...
                <div className="landing-delivery-card">
                  ...
                  <div className="mt-1 text-lg font-extrabold text-slate-900">
                    Live parcel delivery
                  </div>
                  <div className="mt-4 space-y-3 text-xs text-slate-600">
                    <div className="flex gap-3">
                      <MapPin className="mt-0.5 h-4 w-4 text-emerald-600" />
                      <span>
                        <b className="block text-slate-400">Pickup</b>Collection
                        point
                      </span>
                    </div>
                    <div className="flex gap-3">
                      ...
                      <span>
                        <b className="block text-slate-400">Drop-off</b>Delivery
                        destination
                      </span>
                    </div>
                  </div>
                  <div className="mt-4 flex items-center justify-center gap-2 rounded-xl bg-emerald-50 py-3 text-xs font-bold text-emerald-700">
                    <CheckCircle2 className="h-4 w-4" /> Share live tracking
                  </div>
                </div>
              </div>
            </div>

            <div className="landing-parcel landing-parcel-one">
              <Package className="h-8 w-8" />
            </div>
            <div className="landing-parcel landing-parcel-two">
          ...
          <div className="grid overflow-hidden rounded-3xl border border-white/20 bg-white text-slate-900 shadow-[0_28px_70px_-30px_rgba(6,78,59,.55)] sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              { icon: Users, value: "Verified", label: "Courier network" },
              {
                icon: ShieldCheck,
                value: "Protected",
                label: "PIN-confirmed trips",
              },
              { icon: Star, value: "Rated", label: "Service quality" },
            ].map(({ icon: Icon, value, label }, index) => (
              <div
                key={label}
                className={`flex items-center gap-4 px-6 py-6 ${index ? "border-t border-slate-100 sm:border-l sm:border-t-0" : ""}`}
              >
                <span className="grid h-14 w-14 shrink-0 place-items-center rounded-2xl bg-emerald-50 text-emerald-700">
                  <Icon className="h-6 w-6" />
                </span>
                <div>
                  <div className="font-display text-xl font-extrabold text-emerald-950">
                    {value}
                  </div>
      ...
      <section id="how" className="section container-x scroll-mt-24">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-3 text-muted-foreground">
            Three steps between you and delivered.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="mt-3 text-muted-foreground max-w-md">
              Every MoveDek delivery is protected by identity verification, live
              tracking, PIN confirmation, delivery proof and escrow-style
              payments.
            </p>
          </div>
          <div className="grid gap-4 sm:grid-cols-2">
            {trust.map((t) => (
              <div key={t.title} className="card-elevated p-5">
                ...
                <div className="mt-3 font-display font-semibold text-primary">
                  {t.title}
                </div>
      ...
      <section
        id="couriers"
        className="section scroll-mt-24 hero-gradient text-white"
      >
        <div className="container-x grid md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1 grid gap-4 sm:grid-cols-2">
            {couriers.map((c) => (
              <div
                key={c.name}
                className="rounded-2xl bg-white/10 backdrop-blur p-5 ring-1 ring-white/20"
              >
          ...
          <div className="order-1 md:order-2">
            ...
            <p className="mt-3 text-white/80 max-w-md">
              Whether you commute daily, ride a motorcycle, or run a logistics
              fleet — accept jobs that match your route, level and vehicle. Grow
              from Bronze to Platinum and unlock high-value deliveries.
            </p>
            <Link to="/auth/register?role=courier">
              <Button
                size="lg"
                className="mt-6 accent-gradient text-white shadow-glow hover:opacity-95"
              >
                Become a courier
              </Button>
            </Link>
        ...
        <div className="card-elevated overflow-hidden">
          <div className="grid md:grid-cols-2">
            <div className="p-8 md:p-12">
              ...
              <p className="mt-3 text-muted-foreground">
                One dashboard for all your outbound orders — restaurants,
                pharmacies, boutiques, and online shops. Bulk dispatch, saved
                customers, and business-grade tracking.
              </p>
